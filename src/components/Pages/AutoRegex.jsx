...
class App extends React.Component{
  ...
  render(){
    ...
    <div className="jumbotron">
      <h1 className="display-4">Generate Regex Automatically!</h1>
      ...
      <input type="text" className="form-control" placeholder="Sample Data" onChange={this.changeSampleText} value={this.state.sampleText}/>
